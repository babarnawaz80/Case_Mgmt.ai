...
- Name: crawler/00_route_crash_crawler.spec.ts >> Route crash crawler (admin) >> no crash: /people/ind-001/authorizations
- Location: e2e-ipmg/e2e/crawler/00_route_crash_crawler.spec.ts:61:5

# Error details

```
Error: /people/ind-001/authorizations rendered the ErrorBoundary fallback (component crashed on render)
...
- generic [ref=e4]:
  ...
  - paragraph [ref=e10]: Cannot read properties of undefined (reading 'replace')
  - generic [ref=e11]:
