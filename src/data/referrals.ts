...
export type ConversationKind = "email" | "phone" | "note" | "status";
...
export const referrals: Referral[] = [
  {
    ...
    attachments: [
      { id: "a1", name: "Referral Summary.pdf", size: "182 KB", kind: "pdf", autoGenerated: true },
      { id: "a2", name: "Progress Note 04-20-2026.pdf", size: "94 KB", kind: "pdf" },
    ],
    conversation: [
      {
        id: "c1",
        ...
        by: "Kathy Adams",
        initials: "KA",
        date: "04/27/2026 9:15 AM",
        message:
          "Referral email sent to Carroll County Employment Services. Included: Referral Summary, recent progress note.",
        status: "Delivered",
        attachments: ["Referral Summary.pdf", "Progress Note 04-20-2026.pdf"],
      },
      {
        id: "c2",
        type: "phone",
        by: "Kathy Adams",
        initials: "KA",
        date: "04/28/2026 2:30 PM",
        message:
          "Called Carroll County Employment Services. Spoke with intake coordinator Maria Santos. She confirmed they received the referral and will contact Joseph within 5-7 business days. Waitlist is approximately 3 weeks.",
      },
    ],
  },
  {
  ...
  // ─── Lisa Anderson (personId "46") — Referrals Oct 2024–Apr 2025 ──
  {
    id: "R-LA-001",
    personId: "46",
    date: "10/28/2024",
    ...
    priority: "Routine",
    reason:
      "Lisa expressed strong interest in participating in structured community social activities and day program services during her initial home visit. The referral is to enroll Lisa in Carroll Day Services for daily programming including life skills, art, and community outings, aligned with her ISP Community Integration goal.",
    sourceOfNeed: "ISP / Care Plan goal",
    linkedGoalId: "la-g2",
    linkedGoalLabel: "Goal 2 — Community Integration",
    providerId: "P-004",
    providerName: "Carroll Day Services",
    providerPhone: "(712) 555-0188",
    providerAddress: "802 N Adams St, Carroll, IA 51401",
    acceptsMedicaid: true,
    referralMethod: "Phone call",
    contactDate: "10/28/2024",
    contactPerson: "Maria Okafor, Enrollment Coordinator",
    referenceNumber: "CDS-2024-0892",
    infoShared: [
      "Name and contact information",
      "Date of birth",
      "Medicaid / insurance information",
    ...
    consentDocumented: true,
    consentDate: "10/28/2024",
    consentMethod: "Verbal",
    expectedTimeframe: "4-6 weeks",
    followUpDate: "11/18/2024",
    assignedTo: "Kathy Martinez CM",
    notes: "Day program space confirmed for January 6, 2025. Transportation to be coordinated separately.",
    status: "Closed — Successful",
    daysOpen: 0,
    lastActivity: "01/06/2025",
    serviceStartDate: "01/06/2025",
    outcomeNotes: "Lisa enrolled and began attending Carroll Day Services on January 6, 2025. Attendance has been excellent with 97% compliance over 4 months.",
    timeline: [
      { id: "t1", date: "10/28/2024", type: "created", title: "Referral created", by: "Kathy Martinez CM" },
      { id: "t2", date: "10/28/2024", type: "submitted", title: "Submitted to Carroll Day Services via phone", notes: "Reference: CDS-2024-0892", by: "Kathy Martinez CM" },
      { id: "t3", date: "11/04/2024", type: "responded", title: "Carroll Day Services responded — enrollment confirmed", notes: "Space available. Start date January 6, 2025.", by: "Maria Okafor" },
      { id: "t4", date: "01/06/2025", type: "started", title: "Service started — Lisa's first day at Carroll Day Services", by: "Carroll Day Services" },
      { id: "t5", date: "01/08/2025", type: "closed", title: "Closed — Successful", notes: "Lisa attended first 3 sessions. Program is a great fit.", by: "Kathy Martinez CM" },
    ],
    attachments: [
      { id: "la-a1", name: "Day Program Referral Form.pdf", size: "156 KB", kind: "pdf", autoGenerated: true },
      { id: "la-a2", name: "ISP Summary — Community Integration Goal.pdf", size: "88 KB", kind: "pdf" },
    ],
  },
  {
    id: "R-LA-002",
    ...
    priority: "Routine",
    reason:
      "Transportation barriers to community activities identified during March home visit. Carol Anderson (mother) is the sole transportation provider which limits Lisa's ability to participate in community events independently. Medicaid transportation coverage to be coordinated for day program, medical appointments, and community outings.",
    sourceOfNeed: "Case manager recommendation",
    linkedGoalId: "la-g2",
    linkedGoalLabel: "Goal 2 — Community Integration",
    providerId: "P-004",
    providerName: "Carroll Transit System",
    providerPhone: "(712) 555-0301",
    providerAddress: "1002 Plaza Dr, Carroll, IA 51401",
    acceptsMedicaid: true,
    referralMethod: "Online portal",
    contactDate: "03/19/2025",
    contactPerson: "Transit Intake Office",
    referenceNumber: "CTS-2025-0341",
    infoShared: [
      "Name and contact information",
      "Date of birth",
      "Medicaid / insurance information",
      "Address and regular destinations",
    ],
    consentDocumented: true,
    consentDate: "03/18/2025",
    consentMethod: "Written",
    expectedTimeframe: "2 weeks",
    followUpDate: "04/02/2025",
    assignedTo: "Kathy Martinez CM",
    notes: "Medicaid transportation approved for medical appointments and day program. Community outing transport to be arranged separately.",
    status: "Connected",
    daysOpen: 0,
    lastActivity: "04/02/2025",
    serviceStartDate: "04/01/2025",
    outcomeNotes: "Medicaid transportation card issued. Lisa using transit for day program 3 days per week and for PCP appointments.",
    timeline: [
      { id: "t1", date: "03/19/2025", type: "created", title: "Referral created", by: "Kathy Martinez CM" },
      { id: "t2", date: "03/19/2025", type: "submitted", title: "Submitted to Carroll Transit System via portal", notes: "Reference: CTS-2025-0341", by: "Kathy Martinez CM" },
      { id: "t3", date: "03/27/2025", type: "accepted", title: "Transportation approved — Medicaid paratransit eligible", by: "Carroll Transit System" },
      { id: "t4", date: "04/01/2025", type: "started", title: "Service started — transit card issued", by: "Carroll Transit System" },
      { id: "t5", date: "04/02/2025", type: "status-update", title: "Connected — ongoing service confirmed", by: "Kathy Martinez CM" },
    ],
  },
  {
    id: "R-LA-003",
    ...
    priority: "Routine",
    reason:
      "Lisa expressed a strong interest in exploring supported employment opportunities during her April semi-annual ISP review. She has demonstrated significant growth in independent living skills and community participation and is ready to explore part-time work options. Referral to Carroll County Employment Services for vocational assessment and job coaching.",
    sourceOfNeed: "Individual's request",
    linkedGoalId: "la-g2",
    linkedGoalLabel: "Goal 2 — Community Integration / Self-Sufficiency",
    urgencyDate: "07/01/2025",
    providerId: "P-001",
    providerName: "Carroll County Employment Services",
    providerPhone: "(712) 555-0142",
    providerAddress: "1201 E Main St, Carroll, IA 51401",
    providerEmail: "intake@carrollemployment.org",
    acceptsMedicaid: true,
    referralMethod: "Online portal",
    contactDate: "04/15/2025",
    contactPerson: "Intake Coordinator",
    referenceNumber: "CCES-2025-0774",
    infoShared: [
      "Name and contact information",
      "Date of birth",
      "Medicaid / insurance information",
    ...
    consentDocumented: true,
    consentDate: "04/15/2025",
    consentMethod: "Written",
    expectedTimeframe: "4 weeks",
    followUpDate: "05/13/2025",
    assignedTo: "Kathy Martinez CM",
    status: "Pending Response",
    daysOpen: 35,
    lastActivity: "04/15/2025",
    timeline: [
      { id: "t1", date: "04/15/2025", type: "created", title: "Referral created", by: "Kathy Martinez CM" },
      { id: "t2", date: "04/15/2025", type: "submitted", title: "Submitted to Carroll County Employment Services", notes: "Reference: CCES-2025-0774. Awaiting intake appointment scheduling.", by: "Kathy Martinez CM" },
    ],
    attachments: [
      { id: "la-b1", name: "Employment Referral Form.pdf", size: "142 KB", kind: "pdf", autoGenerated: true },
    ],
  },
];
